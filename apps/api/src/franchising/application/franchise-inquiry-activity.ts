import type { AdminFranchiseInquiryActivityItem } from '@mocha-house/contracts';

// Milestone 8D — project the polymorphic InternalAuditEvent rows whose
// targetType is 'franchise_inquiry' into the inquiry activity timeline.
...
export function toFranchiseInquiryActivityItem(
  ...
  let summary: string;
  switch (row.action) {
    case 'franchising.inquiry_status_changed': {

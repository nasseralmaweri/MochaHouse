          ...
          {order.orderPromotion ? (
            <div className="flex items-center justify-between text-sm text-status-success">
              <span>
                ...
                {order.orderPromotion.couponCode
                  ? ` (${order.orderPromotion.couponCode})`
                  : ""}
                {order.orderPromotion.discountType === "FREE_ITEM" &&
                order.orderPromotion.freeItemName
                  ? ` (free ${order.orderPromotion.freeItemName})`
                  : ""}
              </span>
              <span>
          ...
          {order.loyaltyReward ? (
            <div className="flex items-center justify-between text-sm text-status-success">
              <span>
                ...
                {order.loyaltyReward.rewardType === "FREE_ITEM" &&
                order.loyaltyReward.freeItemName
                  ? ` (free ${order.loyaltyReward.freeItemName})`
                  : ""}
              </span>
